...
\begin{itemize}
    \item \(EV1\) Closure under the addition: 
...
\\
\\
Well I notice that I said "the remaining 6 axioms in the sections", which is wrong, are 8 axioms cause we define the closure of addition and closure under scalar multiplication. In total are 10 axioms, not 8.
\\
